...
void lcd_display()
{
	...
	Lcd_cursor(&lcd,0,1);
	Lcd_string(&lcd,"Name:SANTHANA LAKSHMI K\n");

	Lcd_cursor(&lcd,1,1);
	Lcd_string(&lcd,"Reg no:212222240091\n");
	for(int x=0;x<100;x++)
	{
		Lcd_cursor(&lcd,2,1);
		Lcd_int(&lcd,x);
...
## Output screen shots of proteus  :
 ![image](https://github.com/santhanalakshmi04/EXPERIMENT--04-INTERFACING-AN16X2-LCD-DISPLAY-WITH-ARM-/assets/119475762/b4fe1f83-153a-4dbe-8f6c-6725d9cb3bda)

 
 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 
 
 ![image](https://github.com/santhanalakshmi04/EXPERIMENT--04-INTERFACING-AN16X2-LCD-DISPLAY-WITH-ARM-/assets/119475762/8717e418-ed77-4573-acbb-ebe616d61f07)
